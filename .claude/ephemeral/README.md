...
- Anything that documents how the codebase *currently* works — that goes in a regular `.claude/<topic>.md` reference doc.
- Upstream-merge guidance — that's in [`../upstream-sync.md`](../upstream-sync.md).
